...
export type ExamType = 'internal_theory' | 'internal_practice' | 'state_theory' | 'state_practice';
export type ExamStatus = 'scheduled' | 'passed' | 'failed';
export type PaymentType = 'installment' | 'full_course' | 'extra_hours' | 'state_exam_fee';
export type PaymentStatus = 'pending' | 'paid' | 'overdue';
export type ExpenseCategory = 'vehicle_maintenance' | 'fuel' | 'salaries' | 'rent' | 'other';
...
export type InstructorInsert = Omit<Instructor, 'id'> & {
    id?: string;
};
...
export type VehicleInsert = Omit<Vehicle, 'id'> & {
    id?: string;
};
export type StudentCategoryInsert = Omit<StudentCategory, 'id'> & {
    id?: string;
};
export type LessonInsert = Omit<Lesson, 'id' | 'location'> & {
    id?: string;
    location?: string | null;
};
export type ExamInsert = Omit<Exam, 'id'> & {
    id?: string;
};
